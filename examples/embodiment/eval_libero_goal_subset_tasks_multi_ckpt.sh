...
EVAL_SCRIPT="${EMBODIED_PATH}/eval_libero_goal_subset_tasks.sh"

SUBSET_NAME="${1:-subset1}"
CONFIG_NAME="${2:-libero_goal_grpo_openpi_pi05_noise_base90_oneshot}"
WORLD_SIZE="${3:-8}"
BASE_LOG_DIR="${4:-${REPO_PATH}/logs_goal/libero_goal_offline_grpo_openpi_pi05_flow_noise_subset_chain-step2-cosinelr-subsetaware-base90_oneshot_new10_old5/libero_goal_offline_grpo_openpi_pi05_flow_noise_subset1/eval_logs/}"
shift_count=$#
