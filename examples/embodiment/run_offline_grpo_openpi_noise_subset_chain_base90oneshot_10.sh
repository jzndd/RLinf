...
LOG_ROOT="${LOG_ROOT:-${REPO_PATH}/logs_10/${CHAIN_NAME}-step2-cosinelr-subsetaware-base90_oneshot_new10_old5}"
...
EXPERIMENT_NAMES=(
    "libero_10_offline_grpo_openpi_pi05_flow_noise_subset${ACTIVE_SUBSET_ID}"
)
