...
EVAL_SCRIPT="${EMBODIED_PATH}/eval_libero_object_subset_tasks.sh"

SUBSET_NAME="${1:-subset1}"
CONFIG_NAME="${2:-libero_object_grpo_openpi_pi05_noise_base90_oneshot}"
WORLD_SIZE="${3:-8}"
BASE_LOG_DIR="${4:-${REPO_PATH}/logs/eval_libero_object_subset_tasks_multi_ckpt}"
shift_count=$#
