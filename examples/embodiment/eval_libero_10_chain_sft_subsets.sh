...
EVAL_SCRIPT="${EMBODIED_PATH}/eval_libero_10_subset_tasks_use_model_path.sh"

CONFIG_NAME="${1:-libero_10_grpo_openpi_pi05_noise}"
WORLD_SIZE="${2:-8}"
BASE_LOG_DIR="${3:-${REPO_PATH}/logs/eval_libero_10_chain_sft}"
DENOISE_STEP="${4:-2}"
...
CONFIG_PREFIX="pi05_libero_10_subset"
EXP_PREFIX="libero_10_chain_subset_new10_old5_"
...
RUN_GROUP_TAG="$(date +'%Y%m%d-%H%M%S')_libero_10_chain_sft"

echo "============================================================"
echo "LIBERO 10 chain SFT subset eval"
