...
CONFIG_NAME="libero_object_offline_grpo_openpi_pi05_noise_subset_base90_oneshot"
CHAIN_NAME="libero_object_offline_grpo_openpi_pi05_flow_noise_subset_chain"
...
FULL_DATA_PATH="/mnt/project_rlinf/jzn/workspace/openpi/data/libero_object_fullshot"
...
EXPERIMENT_NAMES=(
    "libero_object_offline_grpo_openpi_pi05_flow_noise_subset${ACTIVE_SUBSET_ID}"
)
